...
function mutualInformationBinary(data: Record<string, string>[], a: string, b: string): number {
 ...
 */
export function chowLiuTree(data: Record<string, string>[], variables: string[]): [string, string][] {
 ...
 */
export function orientTreeFromRoot(edges: [string, string][], root: string): [string, string][] {
