...
export async function aprenderEM(graph: BayesGraph, datos: Record<string, string>[], opciones: EMOpciones = {}): Promise<BayesGraph> {
...
function _clonarConEvidencia(graph: BayesGraph, evidencias: Record<string, string>): BayesGraph {
